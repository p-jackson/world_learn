...
- [ ] **Settings**: new-cards/day stepper (default 10) as the only interactive control, persisted via the store; read-only rows — Scheduler (FSRS), Deck (239, incl. contested)
